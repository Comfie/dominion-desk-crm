    ...
    <div className="bg-background min-h-screen">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          <div className="flex items-center gap-4">
            <Link href="/dashboard" className="flex items-center gap-2 text-white">
              ...
              <span className="text-lg font-semibold">Dominion Desk</span>
            </Link>
        ...
        <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
          ...
          <main className="min-w-0">
            ...
            <div className="bg-gradient-blue-cyan mb-12 rounded-xl p-8 text-white shadow-lg">
              <h1 className="text-3xl font-bold sm:text-4xl">Dominion Desk User Guide</h1>
            ...
            <section id="getting-started" className="mb-12 scroll-mt-24">
              ...
              <Card className="mb-6">
                <CardHeader>
                  <CardTitle>Welcome to Dominion Desk</CardTitle>
                </CardHeader>
                <CardContent className="docs-content space-y-4">
                  <p className="text-muted-foreground leading-relaxed">
                    Dominion Desk is a comprehensive property management platform designed
            ...
            <section id="security" className="mb-12 scroll-mt-24">
              ...
              <Card className="mb-6">
                <CardContent className="docs-content space-y-4">
                  ...
                  <p>
                    Dominion Desk is designed to help you comply with South Africa's Protection of
      ...
      <footer className="bg-card border-t py-8">
        <div className="text-muted-foreground mx-auto max-w-6xl px-4 text-center text-sm">
          <p>© {new Date().getFullYear()} Dominion Desk. All rights reserved.</p>
          <p className="mt-2">
